...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`networking-components`](https://github.com/networking-components).

## Canonical organization links

- GitHub organization: https://github.com/networking-components
- Public organization defaults: https://github.com/networking-components/.github
...
`networking-components` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
