...
# Repository relationships for `networking-components`
...
- Inventory digest: `sha256:8e5fa6bd27337d4551480b58710a1220bc2124211885e72b13cad91473b1c73c`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:networking-components` |
| GitHub owner ID | `310324248` |
| Linear project ID | `387c602e-8b41-4b1e-80da-e07ba5c73c11` |
...
|---|---|---|---|
| `networking-components/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
